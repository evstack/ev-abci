...
require (
	...
	github.com/evstack/ev-abci v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/evstack/ev-node/core v1.0.0-beta.1.0.20250905094535-f79548be1384 // indirect
